...
import topicevolutionvis.topic.PCAFlanagan;
...
public class Scores {
        ...
        if (this.nNaN > 0 && !this.noResponseHandlingSet) {
            ...
            if (this.nDeletedItems > 0) {
                ...
                if (this.nItems - this.nDeletedItems <= 1) {
                    throw new IllegalArgumentException("You have deleted " + nDeletedItems + " items leaving " + (this.nItems - this.nDeletedItems) + " items and hence no possibility calculation of alpha");
                }
                ...
                for (int i = 0; i < this.nItems; i++) {
                    if (!this.deletedItems[i]) {
                        ...
                        System.arraycopy(this.scores0[i], 0, scoreTemp[counter], 0, this.nPersons);
            ...
            if (newNaNn > 0) {
                ...
                switch (replacementOption) {
                    ...
                    case 5: // replace missing response by user supplied value for each 'no resonse' occurence
                        ...
                        break;
                    default:
                        throw new IllegalArgumentException("!! It should not be possible to have an option choice (replacementOption) = " + replacementOption);
                }
    ...
    public void enterItemNames(String[] itemNames) {
        ...
        System.arraycopy(itemNames, 0, this.itemNames, 0, len);
    ...
    protected void preprocessData() {
        ...
        if (!this.dataPreprocessed) {
            ...
            switch (this.originalDataType) {
                case 1:
                    holdingArrayS = (String[][]) originalData;
                    ...
                    break;
                case 2:
                    holdingArrayD = (double[][]) originalData;
                    ...
                    break;
                case 3:
                    holdingArrayD = ((Matrix) originalData).getArrayCopy();
                    this.checkLengths(holdingArrayD);
                    // transpose to scores0 format
                    if (this.originalDataOrder == 1) {
                        holdingArrayD = this.transpose1to0(holdingArrayD);
                ...
                case 4:
                    ...
                    break;
                case 5:
                    int[][] holdingArrayI = (int[][]) originalData;
                    ...
                    break;
                case 6:
                    char[][] holdingArrayC = (char[][]) originalData;
                    ...
                    break;
                case 7:
                    holdingArrayB = (boolean[][]) originalData;
                    ...
                    break;
                default:
                    throw new IllegalArgumentException("Original data type, " + originalDataType + ", not recognised");
            }
    ...
    private String[][] dataToString(double[][] ddata) {
        ...
        for (int i = 0; i < nn; i++) {
            for (int j = 0; j < mm; j++) {
                sdata[i][j] = Double.toString(ddata[i][j]);
            }
        }
        return sdata;
    }
    ...
    private String[][] dataToString(boolean[][] ddata) {
        ...
        for (int i = 0; i < nn; i++) {
            for (int j = 0; j < mm; j++) {
                sdata[i][j] = Boolean.toString(ddata[i][j]);
            }
        }
        return sdata;
    }
    ...
    public String[] itemNames() {
        ...
        System.arraycopy(this.itemNames, 0, ret, 0, this.nItems);
        return ret;
    }
    ...
    public String[] originalItemNames() {
        ...
        System.arraycopy(this.originalItemNames, 0, ret, 0, this.originalNitems);
        return ret;
    }
    ...
    public double rawItemMean(int index) {
        ...
        if (index < 1 || index > this.nItems) {
            throw new IllegalArgumentException("The item index, " + index + ", must lie between 1 and the number of items," + this.nItems + ", inclusive");
        }
        if (!this.variancesCalculated) {
            this.meansAndVariances();
        }
    ...
    public double rawPersonMean(int index) {
        ...
        if (index < 1 || index > this.nPersons) {
            throw new IllegalArgumentException("The person index, " + index + ", must lie between 1 and the number of persons," + this.nPersons + ", inclusive");
        }
        if (!this.variancesCalculated) {
            this.meansAndVariances();
        }
    ...
    protected void covariancesAndCorrelationCoefficients() {
        ...
        for (int i = 0; i < this.nItems; i++) {
            for (int j = i; j < this.nItems; j++) {
                ...
                if (i != j) {
                    this.rawCovariances[j][i] = this.rawCovariances[i][j];
                }
            }
        }
        ...
        for (int i = 0; i < this.nItems; i++) {
            for (int j = i; j < this.nItems; j++) {
                ...
                if (i != j) {
                    this.standardizedCovariances[j][i] = this.standardizedCovariances[i][j];
                }
            }
        }
        ...
        for (int i = 0; i < this.nItems; i++) {
            ...
            for (int j = i + 1; j < this.nItems; j++) {
                ...
                if (Fmath.isNaN(this.rawCorrelationCoefficients[i][j])) {
                    this.rawCorrelationCoefficients[i][j] = 0.0;
                }
        ...
        for (int i = 0; i < this.nItems; i++) {
            ...
            for (int j = i + 1; j < this.nItems; j++) {
                ...
                if (Fmath.isNaN(this.standardizedCorrelationCoefficients[i][j])) {
                    this.standardizedCorrelationCoefficients[i][j] = 0.0;
                }
        ...
        for (int i = 0; i < this.nItems; i++) {
            ...
            if (Fmath.isNaN(this.standardizedCorrelationCoefficients[i][this.nItems])) {
                this.standardizedCorrelationCoefficients[i][this.nItems] = 0.0;
            }
    ...
    public double rawCovariance(int index) {
        ...
        if (index < 1 || index > this.nItems) {
            throw new IllegalArgumentException("The first item index, " + index + ", must lie between 1 and the number of items plus one (for totals)," + (this.nItems + 1) + ", inclusive");
        }
        if (!this.covariancesCalculated) {
            this.covariancesAndCorrelationCoefficients();
        }
