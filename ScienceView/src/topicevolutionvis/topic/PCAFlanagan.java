...
public class PCAFlanagan extends Scores {
    ...
    private boolean covRhoOption = true;                               // = true:   covariance matrix used
...
//            this.sign05Bartlett = Stat.chiSquareInverseCDF(this.dfBartlett, 0.95);
            ...
            for (int k = 0; k < this.nItems; k++) {
                double sum = 0.0;
                for (int j = 0; j < this.nItems; j++) {
                    sum += loadingFactorsAsRows[j][k] * loadingFactorsAsRows[j][k];
                }
    ...
    public void rawVarimaxRotation(int nFactors) {
        ...
        System.arraycopy(this.loadingFactorsAsRows, 0, loadingFactorMatrix, 0, nFactors);
    ...
    public void normalVarimaxRotation(int nFactors) {
        ...
        for (int i = 0; i < nItems; i++) {
            ...
            for (int j = 0; j < nFactors; j++) {
                communalityWeights[i] += loadingFactorMatrix[j][i] * loadingFactorMatrix[j][i];
            }
        }
        this.normalVarimaxRotationInHouse(loadingFactorMatrix, communalityWeights);
    }
    ...
    private void normalVarimaxRotationInHouse(double[][] loadingFactorMatrix, double[] communalityWeights) {
        ...
        for (int j = 0; j < nColumns; j++) {
            communalityWeights[j] = Math.sqrt(communalityWeights[j]);
        }
        ...
        double va = PCAFlanagan.varimaxCriterion(this.usRotatedLoadingFactorsAsRows);
        double vaLast = 0;
        double angle = 0;
        boolean test = true;
        this.nVarimax = 0;
        while (test) {
            for (int i = 0; i < nRows - 1; i++) {
                for (int j = i + 1; j < nRows; j++) {
                    angle = PCAFlanagan.varimaxAngle(this.usRotatedLoadingFactorsAsRows, i, j);
                    this.usRotatedLoadingFactorsAsRows = PCAFlanagan.singleRotation(this.usRotatedLoadingFactorsAsRows, i, j, angle);
                    va = PCAFlanagan.varimaxCriterion(this.usRotatedLoadingFactorsAsRows);
                }
            }
        ...
        for (int i = 0; i < nn; i++) {
            System.arraycopy(this.usRotatedLoadingFactorsAsRows[sortedRotIndices[i]], 0, holdDA[i], 0, mm);
        }
        ...
        System.arraycopy(holdIA, 0, this.rotatedIndices, 0, nn);
    ...
    public static double[][] rawVarimaxRotation(double[][] loadingFactorMatrix) {
        ...
        int nIterMax = 1000;
        return PCAFlanagan.rawVarimaxRotation(loadingFactorMatrix, tolerance, nIterMax);
    }
    ...
    public static double[][] rawVarimaxRotation(double[][] loadingFactorMatrix, double tolerance, int nIterMax) {
        ...
        return PCAFlanagan.normalVarimaxRotation(loadingFactorMatrix, communalityWeights, tolerance, nIterMax);
    }
    ...
    public static double[][] normalVarimaxRotation(double[][] loadingFactorMatrix, double[] communalityWeights, double tolerance, int nIterMax) {
        ...
        int nColumns = loadingFactorMatrix[0].length;
        for (int i = 1; i < nRows; i++) {
            if (loadingFactorMatrix[i].length != nColumns) {
        ...
        // Loop through pairwise rotations until varimax function maximised
        double va = PCAFlanagan.varimaxCriterion(rotatedLoadingFactorsAsRows);
        double vaLast = 0;
        double angle = 0;
        boolean test = true;
        int nIter = 0;
        while (test) {
            for (int i = 0; i < nRows - 1; i++) {
                for (int j = i + 1; j < nRows; j++) {
                    angle = PCAFlanagan.varimaxAngle(rotatedLoadingFactorsAsRows, i, j);
                    rotatedLoadingFactorsAsRows = PCAFlanagan.singleRotation(rotatedLoadingFactorsAsRows, i, j, angle);
                    va = PCAFlanagan.varimaxCriterion(rotatedLoadingFactorsAsRows);
                }
            }
    ...
    public static double varimaxCriterion(double[][] loadingFactorMatrix) {
        ...
        for (int j = 0; j < nRows; j++) {
            double sum2 = 0.0;
            for (int k = 0; k < nColumns; k++) {
                sum2 += Math.pow(loadingFactorMatrix[j][k], 2);
            }
            va2 += sum2 * sum2;
        }
        va3 = va1 - va2;
    ...
    public static double[][] singleRotation(double[][] loadingFactorMatrix, int k, int l, double angle) {
        ...
        for (int i = 0; i < nRows; i++) {
            System.arraycopy(loadingFactorMatrix[i], 0, rotatedMatrix[i], 0, nColumns);
        }
...
//        fout.println();
        ...
        fout.print("item", field1);
        for (int i = 0; i < this.nItems; i++) {
            fout.print((this.eigenValueIndices[i] + 1) + " (" + (i + 1) + ")", field2);
        }
        fout.println();
        fout.println("item");
        for (int i = 0; i < this.nItems; i++) {
            fout.print((this.eigenValueIndices[i] + 1) + " (" + (i + 1) + ")", 2 * field1);
            for (int j = 0; j < this.nItems; j++) {
                fout.print(Fmath.truncate(this.covarianceMatrix.getElement(j, i), this.trunc), field2);
            }
            fout.println();
        }
        ...
        for (int i = 0; i < this.nItems; i++) {
            ...
            for (int j = 0; j < this.nItems; j++) {
                fout.print(Fmath.truncate(this.orderedEigenVectorsAsRows[i][j], this.trunc), field2);
            }
            fout.println();
        }
        fout.println();
        ...
        for (int i = 0; i < this.nItems; i++) {
            fout.print((i + 1) + " (" + (this.eigenValueIndices[i] + 1) + ")", 2 * field1);
            for (int j = 0; j < this.nItems; j++) {
                fout.print(Fmath.truncate(this.loadingFactorsAsRows[i][j], this.trunc), field2);
            }
            fout.print(" ", field1);
            fout.print(Fmath.truncate(this.orderedEigenValues[i], this.trunc), field2);
    ...
    private void analysisExcel() {
        ...
        for (int i = 0; i < this.nItems; i++) {
            ...
            fout.printtab(" ");
            for (int j = 0; j < this.nItems; j++) {
                fout.printtab(Fmath.truncate(this.correlationMatrix.getElement(j, i), this.trunc));
            }
            fout.println();
        }
        fout.println();
        ...
        for (int i = 0; i < this.nItems; i++) {
            ...
            fout.printtab(" ");
            for (int j = 0; j < this.nItems; j++) {
                fout.printtab(Fmath.truncate(this.partialCorrelationMatrix.getElement(j, i), this.trunc));
            }
            fout.println();
        }
        fout.println();
        ...
        for (int i = 0; i < this.nItems; i++) {
            ...
            fout.printtab(" ");
            for (int j = 0; j < this.nItems; j++) {
                fout.printtab(Fmath.truncate(this.covarianceMatrix.getElement(j, i), this.trunc));
            }
            fout.println();
        }
        fout.println();
        ...
        for (int i = 0; i < this.nItems; i++) {
            ...
            fout.printtab(" ");
            for (int j = 0; j < this.nItems; j++) {
                fout.printtab(Fmath.truncate(this.orderedEigenVectorsAsRows[i][j], this.trunc));
            }
            fout.println();
        }
        fout.println();
        ...
        for (int i = 0; i < this.nItems; i++) {
            ...
            fout.printtab(" ");
            for (int j = 0; j < this.nItems; j++) {
                fout.printtab(Fmath.truncate(this.loadingFactorsAsRows[i][j], this.trunc));
            }
            fout.printtab(" ");
            fout.printtab(Fmath.truncate(this.orderedEigenValues[i], this.trunc));
