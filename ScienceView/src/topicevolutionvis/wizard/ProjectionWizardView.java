...
public class ProjectionWizardView extends javax.swing.JDialog {
    ...
    private ProjectionWizardView() {
        super(ScienceViewMainFrame.getInstance());
        initComponents();
        this.setPreferredSize(new Dimension(700, 600));
        this.setSize(700, 600);
        this.nextButton.setMinimumSize(new Dimension(75, 23));
    }
    ...
    private void nextButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_nextButtonActionPerformed
        ...
        ProjectionData pdata = this.process.pdata;
        if (this.dataPanel instanceof DataSourceChoice) {
            if (pdata.getCollectionName() != null) {
                ...
                JOptionPane.showMessageDialog(this, "A corpus must be provided.", "Warning", JOptionPane.WARNING_MESSAGE);
            }
        } else {
            this.definePanel(ProjectionWizardCore.NEXT_STATE);
        }
