 ...
 *
 * ***** END LICENSE BLOCK ***** */
package topicevolutionvis.preprocessing.steemer;
...
public class StemmerFactory {
    ...
    public static Stemmer getInstance(StemmerType.Type type) {
        if (type == StemmerType.Type.PORTER) {
            return new SnowBallWrapper(porterStemmer.class);
        } else if (type == StemmerType.Type.ENGLISH) {
            return new SnowBallWrapper(englishStemmer.class);
        } else if (type == StemmerType.Type.PORTUGUESE) {
            return new SnowBallWrapper(portugueseStemmer.class);
        } else if (type == StemmerType.Type.SPANISH) {
            return new SnowBallWrapper(spanishStemmer.class);
        } else if (type == StemmerType.Type.FRENCH) {
