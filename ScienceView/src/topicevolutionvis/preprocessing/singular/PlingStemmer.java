package topicevolutionvis.preprocessing.singular;
...
public class PlingStemmer {
    ...
    public static Set<String> categorySE_SES = new FinalSet<>(
            "cases",
            "cruises",
            "diseases",
            "increases",
            "nurses");
    /** Words that end in "-se" in their plural forms (like "nurse" etc.)*/
    public static Set<String> categoryZE_ZES = new FinalSet<>(
            "sizes",
            "rationalizes");
    /** Words that do not have a distinct plural form (like "atlas" etc.)*/
    public static Set<String> category00 = new FinalSet<>(
            "alias",
            "analogous",
            "anomalous",
            "asbestos",
    ...
    public static Set<String> categoryUM_A = new FinalSet<>(
            "addenda",
            "agenda",
            "aquaria",
            "bacteria",
    ...
    public static Set<String> categoryON_A = new FinalSet<>(
            "aphelia",
            "asyndeta",
            "automata",
            "criteria",
    ...
    public static Set<String> categoryO_I = new FinalSet<>(
            "alti",
            "bassi",
            "canti",
            "contralti",
    ...
    public static Set<String> categoryUS_I = new FinalSet<>(
            "alumni",
            "bacilli",
            "cacti",
            "foci",
    ...
    public static Set<String> categoryIX_ICES = new FinalSet<>(
            "appendices",
            "cervices");
    /** Words that change from "-is" to "-es" (like "axis" etc.), listed in their plural forms*/
    public static Set<String> categoryIS_ES = new FinalSet<>(
    ...
    public static Set<String> categoryOE_OES = new FinalSet<>(
            "aloes",
            "backhoes",
            "beroes",
            "canoes",
    ...
    public static Set<String> categoryEX_ICES = new FinalSet<>(
            "apices",
            "codices",
            "cortices",
            "indices",
    ...
    public static Set<String> categoryU_US = new FinalSet<>(
            "apercus",
            "barbus",
            "cornus",
            "ecrus",
    ...
    public static Set<String> categorySSE_SSES = new FinalSet<>(
    ...
    public static Set<String> categoryCHE_CHES = new FinalSet<>(
            "adrenarches",
            "attaches",
            "avalanches",
            "barouches",
    ...
    public static Set<String> categoryICS = new FinalSet<>(
            "aerobatics",
            "aerobics",
            "aerodynamics",
            "aeromechanics",
    ...
    public static Set<String> categoryIE_IES = new FinalSet<>(
            "aeries",
            "anomies",
            "aunties",
            "baddies",
    ...
    public static Map<String, String> irregular = new FinalMap<>(
            "beefs", "beef",
            "beeves", "beef",
            "brethren", "brother",
            "busses", "bus",
    ...
    public static Set<String> singAndPlur = new FinalSet<>(
            "acoustics",
            "aestetics",
            "aquatics",
            "basics",
