...
public class Char {
    ...
    public static Map<Character, String> charToAmpersand = new FinalMap<>('&', "&amp;", '\'', "&apos;", '<', "&lt;", '>', "&gt;", '"',
            "&quot;");
    /** Maps HTML ampersand sequences to strings */
    public static Map<String, Character> ampersandMap = new FinalMap<>("nbsp", (char) 160, "iexcl", (char) 161, "cent", (char) 162,
    ...
    public static Map<Character, String> normalizeMap = new TreeMap<>();
    ...
    public static String normalize(int c) {
        ...
        if (normalizeMap.get(cu) != null) {
            return (u ? normalizeMap.get(cu) : normalizeMap.get(cu).toLowerCase());
        }
    ...
    public static char eatUtf8(String a, int[] n) {
        ...
        if (a.length() >= n[0]) {
            switch (n[0]) {
                ...
                case 3:
                    if ((a.charAt(1) & 0xC0) != 0x80 || (a.charAt(2) & 0xC0) != 0x80) {
                        break;
                    }
                    return ((char) (((a.charAt(0) & 0x0F) << 12) + ((a.charAt(1) & 0x3F) << 6) + ((a.charAt(2) & 0x3F))));
                case 4:
                    if ((a.charAt(1) & 0xC0) != 0x80 || (a.charAt(2) & 0xC0) != 0x80 || (a.charAt(3) & 0xC0) != 0x80) {
                        break;
                    }
    ...
    public static String encodeUTF8(int c) {
        ...
        if (c <= 0xFFFF) {
            return ("" + (char) (0xE0 + ((c >> 12) & 0x0F)) + (char) (0x80 + ((c >> 6) & 0x3F)) + (char) (0x80 + (c & 0x3F)));
        }
        return ("" + c);
    }
